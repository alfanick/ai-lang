...
namespace AI {
  enum token_type {T_UNKNOWN, T_NUMBER, T_STRING, T_SYMBOL, T_OPERATOR, T_LB, T_RB, T_COMMENT, T_LC, T_RC, T_LS, T_RS, T_SEMICOLON, T_COMMA, T_NOP, T_BEGIN};
